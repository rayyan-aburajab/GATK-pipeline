...
#SBATCH --job-name=step7-alt2.sh    # Job name
...
#SBATCH --output=step7_alt_%j.log   # Standard output and error log
...
gatk CNNScoreVariants \
   ...
   -O "$DATA_DIR/C083-000002_GermlineDNA_CNNannotated2.vcf" \
