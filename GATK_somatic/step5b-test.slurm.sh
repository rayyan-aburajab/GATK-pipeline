...
#SBATCH --job-name=step5b-test.sh    # Job name
...
#SBATCH --output=step5b-test_%j.log   # Standard output and error log

DATA_DIR="/coh_labs/dits/rayyan/Data/C083-000002/StrelkaTest"
