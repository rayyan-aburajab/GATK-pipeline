...
VCF_SNP_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_GermlineDNA/{SAMPLE_NAME}_GermlineDNA_SNP_clinvar.vcf'
VCF_INDEL_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_GermlineDNA/{SAMPLE_NAME}_GermlineDNA_INDEL_clinvar.vcf'

output_txt_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_GermlineDNA/{SAMPLE_NAME}_variant_results.txt'
