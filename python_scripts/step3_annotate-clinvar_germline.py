...
VCF_SNP_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_GermlineDNA/{SAMPLE_NAME}_GermlineDNA_SNP_reformat.vcf'
VCF_INDEL_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_GermlineDNA/{SAMPLE_NAME}_GermlineDNA_INDEL_reformat.vcf'

output_SNP_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_GermlineDNA/{SAMPLE_NAME}_GermlineDNA_SNP_clinvar.vcf'
output_INDEL_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_GermlineDNA/{SAMPLE_NAME}_GermlineDNA_INDEL_clinvar.vcf'
