...
VCF_file = '/coh_labs/dits/rayyan/Data/C083-000002/AnalysisData_germline/C083-000002_GermlineDNA_func_splitINDEL-dbsnp.vcf'
...
with open(VCF_file, 'r') as VCF:
    for line in VCF:
        ...
        if (
                ...
                float(info_dict.get('ReadPosRankSum', float('-inf'))) >= -20.0 and
                (info_dict.get('ReadPosRankSum') is None or float(info_dict['ReadPosRankSum']) -20.0) and
...
output_VCF = '/coh_labs/dits/rayyan/Data/C083-000002/PythonAnalysis_germline/C083-000002_GermlineDNA_INDEL_filtered.vcf'
