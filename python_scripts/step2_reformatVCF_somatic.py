...
VCF_SNP_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_TumorDNA/{SAMPLE_NAME}_TumorDNA_somatic.snvs.filtered.vcf'
VCF_INDEL_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_TumorDNA/{SAMPLE_NAME}_TumorDNA_somatic.indels.filtered.vcf'

output_SNP_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_TumorDNA/{SAMPLE_NAME}_TumorDNA_somatic.snvs.reformat.vcf'
output_INDEL_file = f'/coh_labs/dits/rayyan/Data/{SAMPLE_NAME}/PythonAnalysis_TumorDNA/{SAMPLE_NAME}_TumorDNA_somatic.indels.reformat.vcf'
