...
#SBATCH --job-name=GATK_step1.sh    # Job name
...
#SBATCH --output=GATK_step1_%j.log   # Standard output and error log

DATA_DIR="/coh_labs/dits/rayyan/Data/C083-000002/SV_analysis/GATK_CNV"
...
gatk PreprocessIntervals \
 ...
 -L "$IL_DIR/ID2_hg38_tempe_ensembl_v103.targets.interval_list" \
 --bin-length 0 \
 --interval-merging-rule OVERLAPPING_ONLY \
 -O "$IL_DIR/ID2_hg38_tempe_ensembl_v103.targets_preprocessed.interval_list"