...
gatk ApplyVQSR \
   ...
   -V "$DATA_DIR/C083-000002_GermlineDNA_VSQR-snp.vcf.gz" \
   -O "$DATA_DIR/C083-000002_GermlineDNA_VSQR-snp-indel.vcf.gz" \
   --truth-sensitivity-filter-level 99.0 \
   --tranches-file "$DATA_DIR/C083-000002_GermlineDNA_VSQR-indel.tranches" \
   --recal-file "$DATA_DIR/C083-000002_GermlineDNA_VSQR-indel.recal" \
   -mode INDEL